   ...
   <div class="col-md-12">
      <div class="card">
         ...
         <div class="card-body">
            ...
            <a href="{{route('rawdata-rekon.delete')}}" class="btn btn-danger" onclick="return confirm('Apakah anda yakin ingin menghapus semua rawdata ?');"><i class="fa fa-trash"></i><span> Hapus Data</span></a>
            <br> <br>
