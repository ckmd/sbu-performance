    ...
    'menu' => [
        ...
        [
            ...
            'submenu' => [
                    ...
                    [
                        'can'         => 'isSuperadmin',
                        'text'        => 'Upload Raw Data CRM',
                        'url'         => '/rawdata',
                        'icon'        => 'fa fa-fw fa-upload',
                    ],
                    [
                        'can'         => 'isSuperadmin',
                        'text'        => 'View All Data CRM',
                        'url'         => '/alldata',
                        'icon'        => 'fa fa-fw fa-file',
                    ],
                    ['header' => 'Rekon'],
                    [
                        'text'        => 'Dashboard Rekon',
                        'url'         => '/dashboard-rekon',
                        'icon'        => 'fa fa-fw fa-table',
                    ],
                    [
                        'can'         => 'isSuperadmin',
                        'text'        => 'Upload Raw Data Rekon',
                        'url'         => '/rawdata-rekon',
                        'icon'        => 'fa fa-fw fa-upload',
                    ],
                    [
                        'can'         => 'isSuperadmin',
                        'text'        => 'View All Data Rekon',
                        'url'         => '/alldata-rekon',
                        'icon'        => 'fa fa-fw fa-file',
                    ],
