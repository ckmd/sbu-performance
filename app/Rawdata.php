...
class Rawdata extends Model
{
    protected $fillable = [
        ...
        , 'Service ID', 'Customer', 'Region SBU (Terminating) (Address)',
    ];
}
        // 'Created On', 'Close Date', 'Interference Time', 'Service ID Status', 'Product', 'Interference Cause (Incident ID) (Incident)',
